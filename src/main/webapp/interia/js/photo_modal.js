...
$(grid_a).on("click",function() {
	...
	$("#bookmark_off").on("click", function() {
	  $(this).css("display","none");
	  $("#bookmark_on").css("display","flex");
	});
	$("#bookmark_on").on("click", function() {
	  $(this).css("display","none");
	  $("#bookmark_off").css("display","flex");
	});
